-- ============================================
-- NAPRAWA RLS - WERSJA 2
-- ============================================
-- Poprzednia migracja mogła zepsuć dostęp
-- Ta migracja naprawia polityki
...
BEGIN
    ...
    -- SELECT - dla authenticated i anon
    EXECUTE format('
...
-- ============================================
-- STORAGE BUCKETS - napraw polityki
-- ============================================

-- Usuń wszystkie stare polityki storage
DO $$
DECLARE
    pol RECORD;
BEGIN
...
-- Utwórz proste polityki dla storage
-- SELECT - wszyscy mogą czytać publiczne buckety
CREATE POLICY "storage_public_select" ON storage.objects
FOR SELECT USING (true);

-- INSERT - authenticated mogą uploadować
CREATE POLICY "storage_auth_insert" ON storage.objects
FOR INSERT TO authenticated WITH CHECK (true);

-- UPDATE - authenticated mogą aktualizować
CREATE POLICY "storage_auth_update" ON storage.objects
FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

-- DELETE - authenticated mogą usuwać
...
SELECT 'Migracja RLS v2 zakończona!' as status;
