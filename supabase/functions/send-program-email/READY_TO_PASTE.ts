// ================================================================
// Edge Function: send-program-email
// Skopiuj cały ten kod i wklej w Supabase Dashboard
// ================================================================
  ...
  try {
    ...
    if (filePath) {
      try {
        ...
        // Download file from Storage using service role key (full permissions)
      ...
      // Fallback: If no filePath, try to fetch from URL
      try {
