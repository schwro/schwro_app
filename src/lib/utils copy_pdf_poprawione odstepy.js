...
export const generatePDF = async (program, songsMap) => {
  ...
  // Podziel content na sekcje: page-1, sections-wrapper, renderSongsPages
  ...
  // Funkcja do renderowania sekcji
  ...
  // Renderuj każdą sekcję na nowej stronie
  try {
...
// --- FUNKCJE DO ZAPISU PDF NA DYSK I DO SUPABASE ---
